...
public class GuiFrame  extends JFrame {
	...
	private JList<String> searchedContactsList;

	private JTable meetingDataTable;
	private JList<String> meetingsList;
	private JList<String> searchedMeetingsList;
	...
	public GuiFrame() {
		...
		contactsList = new JList<String>(contacts);
		...
		searchedContactsList = new JList<String>();
		...
		meetingsList = new JList<String>(meetings);
		...
		searchedMeetingsList = new JList<String>();
